                    ...
                    <div class="row d-flex justify-content-center align-items-center">
                        <div class="col-12 col-md-7 col-lg-7 col-xl-7">
                            <div class="" style="max-width: 100%; margin: 0 auto;">
                                <div class=" p-5">
                                    <form method="POST" action="${pageContext.request.contextPath}/customer/create" id="customerForm">
                                        ...
                                        <div class="form-group mb-3 text-white">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <button class="btn btn-light" type="button" onclick="togglePasswordVisibility('confirmPassword')">
            ...
            $(document).ready(function () {
                ...
                function validateForm() {
                    ...
                    if (isValid) {
                        ...
                        var message = userID + " has been added.";
                ...
                function validateConfirmPassword() {
                    ...
                    errorElement.css('color', 'red');
                    if (!confirmPassword) {
                        errorElement.text('Confirm Password is required.');
                        return false;
                    }
                ...
                function validateMobileNumber() {
                    ...
                    // Add the validation for 11 numbers
                    if (mobileNumber.length !== 11) {
                        errorElement.text('Mobile Number must have exactly 11 numbers.');
                        return false;
                    }
