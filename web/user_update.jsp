            ...
            <div class="col-lg-12">
                <div class="modal-content">
                    <div class="container-fluid">
                        <form method="POST" action="${pageContext.request.contextPath}/user/update" id="userForm" style="width: 600px;margin: 4rem auto;">               
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="userID" required
                                    value="<c:out value='${userDetails.userID}'/>" name="userID" readonly>
                                <div id="userIDError" class="text-danger"></div>
                            </div>
                            <div class="form-group">
                                <label for="firstName">First Name:</label>
                                <input type="text" class="form-control" id="firstName" required
                                       value="<c:out value='${userDetails.firstName}'/>" name="firstName">
                                <div id="firstNameError" class="text-danger"></div>
                            </div>
                            <div class="form-group">
                                <label for="middleName">Middle Name:</label>
                                <input type="text" class="form-control" id="middleName" 
                                       value="<c:out value='${userDetails.middleName}'/>" name="middleName">
                            </div>
                            <div class="form-group">
                                <label for="lastName">Last Name:</label>
                                <input type="text" class="form-control" id="lastName" required
                                       value="<c:out value='${userDetails.lastName}'/>" name="lastName">
...
<!--                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="input-group form-select form-control" id="userRole" required
                                        value="<c:out value='${userDetails.userRole}'/>" name="userRole">
                                    <option selected><c:out value="${userDetails.userRole}"/></option>
            ...
            $(document).ready(function () {
                ...
                function validateForm() {
                    ...
                    if (isValid) {
                        ...
                        var message = firstName + " has been updated!";
