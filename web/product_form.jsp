            ...
            <div class="col-lg-12">
                <div class="modal-content">
                    <div class="container-fluid">
                        <form method="POST" action="${pageContext.request.contextPath}/products/create" id="productForm" style="width: 600px;margin: 4rem auto;">               
        ...
        $(document).ready(function () {
            ...
            function validateForm() {
                ...
                if (isValid) {
                    ...
                    var message = productId + " with name " + productName + " has been added to inventory";
                    alert(message);
                }
