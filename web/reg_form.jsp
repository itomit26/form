                                    ...
                                    <form>
                                        ...
                                        <div class="form-check d-flex justify-content-center mb-5">
                                            ...
                                            <label class="form-check-label text-white" for="form2Example3g">
                                                I agree on all statements in <a href="terms and conditions.jsp" class="text-form text-white"><u>Terms and Conditions</u></a>
                                            </label>
                                        </div>     
                                        <div class="d-grid place-items-center">

                                            <button type="submit" class="text-form btn btn-danger btn-block btn-lg text-white btn-primary btn btn-primary">Submit</button>
                                        </div>
                                        <p class="text-center mt-5 mb-0 text-white">Have an account already? 
                                            <a href="log_in.jsp"class="text-form fw-bold text-white"><u>Login here</u></a></p>
                                    </form>
